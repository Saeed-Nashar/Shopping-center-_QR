...
import 'package:flutter_app/LoginAndResetAndSignUp/registration/registration.dart';
  ...
  Widget build(BuildContext context) {
    ...
    final loginButton = Material(
      ...
      child: MaterialButton(
          ...
          onPressed: () {
           // _submitLogin();
            Navigator.push(context, MaterialPageRoute(builder: (builder)=>TabBar_Screen()));
